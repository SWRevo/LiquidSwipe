package id.indosw.liquidswipe_lib
...
import id.indosw.liquidswipe_lib.animation.AnimationHelper
import id.indosw.liquidswipe_lib.animation.Direction.LEFT
import id.indosw.liquidswipe_lib.animation.Direction.NONE
import id.indosw.liquidswipe_lib.animation.Direction.RIGHT
...
abstract class EdgeController(
    ...
    private val SWITCH_ANIMATION_DURATION = 700L
